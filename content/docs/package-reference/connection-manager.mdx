...
This is useful in seeders or any code that needs all-or-nothing behavior across multiple statements. See [Manual Transactions](/docs/migrations/transactions#manual-transactions) for more.
