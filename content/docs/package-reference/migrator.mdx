...
| `TaggedSeeder` | `Tags() []string` | Interface for tag-based seeder filtering *(v1.3.0)* |
| `RollbackableSeeder` | `Rollback(db) error` | Interface for seeder rollback support *(v1.3.0)* |
