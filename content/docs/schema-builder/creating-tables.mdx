...
The first argument is the table name. The callback receives a Blueprint where you define columns using chainable methods. `Create` returns an `error` — return it from your migration's `Up` method.
