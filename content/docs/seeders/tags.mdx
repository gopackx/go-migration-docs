...
_ = reg.Register("DevUserSeeder", &seeders.DevUserSeeder{})
_ = reg.Register("ProdDefaultsSeeder", &seeders.ProdDefaultsSeeder{})
_ = reg.Register("TestFixtureSeeder", &seeders.TestFixtureSeeder{})
...
func main() {
    ...
    reg := seeder.NewRegistry()
    _ = reg.Register("DevUserSeeder", &seeders.DevUserSeeder{})           // tags: development, testing
    _ = reg.Register("ProdDefaultsSeeder", &seeders.ProdDefaultsSeeder{}) // tags: production
    _ = reg.Register("RoleSeeder", &seeders.RoleSeeder{})                 // no tags
