...
| Migration | Batch |
|-----------|-------|
| `20240101000001_create_users_table` | 1 |
| `20240115000001_create_posts_table` | 1 |
| `20240201000001_add_phone_to_users` | 2 |
| `20240215000001_create_comments_table` | 2 |
...
1. `20240215000001_create_comments_table` (batch 2)
2. `20240201000001_add_phone_to_users` (batch 2)
3. `20240115000001_create_posts_table` (batch 1)

Only `20240101000001_create_users_table` remains.
