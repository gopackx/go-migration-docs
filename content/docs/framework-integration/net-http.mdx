...
```go title="migrations/20240401120000_create_products_table.go"
package migrations
...
func (m *CreateProductsTable) Down(s *schema.Builder) error {
    return s.DropIfExists("products")
}
```
...
func main() {
    ...
    m.Register("20240401120000_create_products_table", &migrations.CreateProductsTable{})
