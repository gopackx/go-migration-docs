...
<Callout type="info">
  **New in v1.2.0:** If you don't need custom CLI logic, you can use `migrator.Run()` instead of building a custom binary. It handles config loading, DB connection, auto-discovery, and command dispatch in a single call. See [Quick Start](/docs/getting-started/quick-start) for details.
</Callout>
